...
//    	this.cellMatrixNeutral = new int [_h / Cell.SIZE][_w / Cell.SIZE];
//    	setInterval(10);
//    }
//    
//    /*
...
//					cellMatrixOld[r][c] = cellMatrix[r][c];
//				}
...
//	 * 
//	 */
//	private HashMap<Integer, ArrayList<Cell>> cellMotion = new HashMap<>();
//	
//	
//	
//	/*
...
//	 */
//
//    private int[][] cellMatrixNeutral = null;   
//    private void createNeutralCellMatrix() {
//    	// Battle Msg
//    	for (int x = 100; x < 120; x++) {
//    		for (int y = 0; y < 160; y++) {
//    	    	cellMatrixNeutral[x][y] = 1;
//    		}
//    	}
//    	// Main Character
//    	for (int x = 46; x < 62; x++) {
...
//		for (int x = 0; x < cellMatrix.length; x++) {
//			for (int y = 0; y < cellMatrix[x].length; y++) {
//				if (cellMatrixNeutral[x][y] == 1) {
//					continue;
//				}
//				boolean dark = isDark(cellMatrix[x][y]);
//				if (dark) {
//					cellMatrix[x][y].createAveragePixels(false, 10);
//				}
//				else {
//					cellMatrix[x][y].createAveragePixels(true,  10);	
//				}
//			}
//		}
//    }
