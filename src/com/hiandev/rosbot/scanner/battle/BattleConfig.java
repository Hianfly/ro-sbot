...
public class BattleConfig extends Config {
	...
	public static int SHOW_PREVIEW = 0;
	...
	public static int USE_POTION_IF_SP_BELOW_THAN = 0;

	public static int MAX_DISTANCE_WHEN_MOVING_AFTER_TELEPORT = 0;
	public static int MIN_DISTANCE_WHEN_MOVING_AFTER_TELEPORT = 0;
	...
	protected void onLoaded() {
		...
		SHOW_PREVIEW        		 			= getInt("show_preview", SHOW_PREVIEW);
		...
		MAX_DISTANCE_WHEN_MOVING_AFTER_TELEPORT = getInt("max_distance_when_moving_after_teleport", MAX_DISTANCE_WHEN_MOVING_AFTER_TELEPORT);
		MIN_DISTANCE_WHEN_MOVING_AFTER_TELEPORT = getInt("min_distance_when_moving_after_teleport", MIN_DISTANCE_WHEN_MOVING_AFTER_TELEPORT);
